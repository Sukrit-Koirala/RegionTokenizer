...
#
# TXL Detail Resolver V1 — Transformer-XL-Style Detail Memory Resolver
#
# Stage 3: Tests whether Transformer-XL-style local contextual memory
# over input_ids improves candidate selection and gate calibration over
# Stage 2C (which used raw token-embedding cross-attention).
#
# Stage 2C results:
#   apply_rate = 0.0798
#   changed_to_gold = 0.0084
#   changed_away = 0.0089
#   full_vocab_gain = -0.0017
#   selected_gold_given_in_pool = 0.2457
#   applied_precision_ctg = 0.1047
#
# Architecture: TXL detail encoder → candidate-conditioned attention
#   → selector scores + gate logit → surgical edit if gate passes.
#
...
# Stage 2C ref: ctg=0.0084, caw=0.0089, fv_gain=-0.0017
...
RUN_NAME="txlmem_selector_gate_v1"
OUT_ROOT="runs/txl_detail_resolver_v1"
...
echo "========================================================"
echo " TXL Detail Resolver V1 — Transformer-XL-Style Memory"
...
echo "[launch] Starting TXL Detail Resolver V1 training..."
echo ""

# NOTE: --selector_margin_thresholds uses = form (value starts with -999)
...
echo ""
echo "========================================================"
echo " TXL Detail Resolver V1 complete. $(date)"
echo "========================================================"
echo ""
echo "Key outputs:"
...
echo "  ${RUN_DIR}/best_txl_detail_resolver.pt"
...
print('=== TXL Detail Resolver V1 — Final Results ===')
print()
...
print('[reference — Stage 2C]')
print('  apply_rate                                           = 0.0798')
print('  changed_to_gold_rate                                 = 0.0084')
print('  changed_away_rate                                    = 0.0089')
print('  full_vocab_gain                                      = -0.0017')
print('  selected_gold_given_in_pool                          = 0.2457')
print('  applied_precision_ctg                                = 0.1047')
